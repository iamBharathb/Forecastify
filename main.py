...
start_date = st.sidebar.date_input("Start date", date(2008, 1, 1), key=start_date_key)
end_date = st.sidebar.date_input("End date", date.today())

# Header
st.markdown("<h1 style='text-align: center;'>ENHANCED STOCK FORECASTING📈</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'><b>FORECASTIFY</b><b style='color: orange'>fy</b> is a web app for stock price prediction using the hybrid LSTM-Prophet model</p>", unsafe_allow_html=True)
